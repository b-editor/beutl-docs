...
ツールタブは、シーンエディタの周囲にドッキングして使用する作業領域です。
タイムラインやライブラリ、プロパティなど用途別のタブに分かれており、
ドラッグして配置を変えたり、複数のタブを重ねたり並べたりできます。

## タブの開き方とリセット

- メニューバーの **「表示」→「ツール」** から、現在閉じているタブを開けます。
- タブのヘッダをドラッグすると、別のドック領域へ移動できます。
- **「表示」→「ドックレイアウトをリセット」** を選ぶと、タブの配置を初期状態に戻せます。

「シーン設定」と「グラフエディタ」のタブは「表示」→「ツール」のメニューには現れません。
それぞれの開き方は各ページで説明します。
